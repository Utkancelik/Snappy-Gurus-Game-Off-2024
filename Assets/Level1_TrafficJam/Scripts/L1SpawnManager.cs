...
public class L1SpawnManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        L1GameManager.Instance.OnGameOver.AddListener(KillCoroutines);
    }
    ...
    IEnumerator SpawnObstacle()
    {
        while (true)
        {
            ...
            car.GetComponent<L1ObstacleMovementController>().SpriteRenderer.sprite = _carSprites[Random.Range(0, 7)];
